...
@WebServlet(name="UnbanUserServlet", urlPatterns={"/UnbanUserServlet"})
public class UnbanUserServlet extends HttpServlet 
{
            ...
            if(someone != null) //có đăng nhập
            {
                if(someone.getRole().equals("A")) //admin
                {
                    ...
                    if(cachetool != null) //phải có gì đó từ userlist
                    {
                        ...
                        boolean IsItBanned = dao.unbanAccount(email);
                        if(IsItBanned)
                        {
                            cachetool.UnbanFullList(email);
    ...
    throws ServletException, IOException {
        ...
        {
            Logger.getLogger(UnbanUserServlet.class.getName()).log(Level.SEVERE, null, ex);
        } catch (SQLException ex)
        {
            Logger.getLogger(UnbanUserServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
