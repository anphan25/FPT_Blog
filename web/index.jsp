    ...
    <%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
        ...
        <head>
            ...
            <link
                ...
                rel="stylesheet" />
            <script src="https://kit.fontawesome.com/03ade0a214.js" crossorigin="anonymous"></script>
                    ...
                    <div class="main_container_left">
                        ...
                        <a href="https://daihoc.fpt.edu.vn" target="_blank">
                            <div style="margin-top: 3rem">
                                <div class="introduce_community">
                                    <h2 class="introduce_title">
                                        <img src="https://firebasestorage.googleapis.com/v0/b/udemy-vue-firebase-si.appspot.com/o/spnsors.jpg?alt=media&token=6743a747-baca-40f6-9f3a-dbe40e1c0a99"
                                            width="100%" style="border-radius: 4px; margin-bottom: 0.5rem" />
                                        <span class="brand_text_sponsors">New Champion-Brand FPT DEV Wear is
                                            Here!</span>
                                    </h2>
                                </div>
                            </div>
                    ...
                    <div class="main_container_middle">
                                                            ...
                                                            <c:forEach var="award" items="${blogDTO.awards}">
                                                                ...
                                                                <c:if test="${award == 2}">
                                                                    <img src="./images/heart-award.png" alt=""
                                                                        title="Like Collector" />
                                                                </c:if>
                                                                <c:if test="${award == 3}">
                                                                    <img src="./images/top-author.png" alt=""
                                                                        title="Excellent Writer" />
                                                                </c:if>
                                                            </c:forEach>
                                                        </c:if>
                                                    </p>
                        ...
                        <div class="pagingIndex">
                            ...
                            <c:forEach begin="1" end="${requestScope.ENDPAGE}" var="i">
                                <a class="${activeIndex == i ? " active": "" } indexPage"
                                    href="loadBlogs?index=${i}">${i}</a>
                            </c:forEach>
                        </div>
                    </div>
