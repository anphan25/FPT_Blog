                    ...
                    <c:choose>
                        <c:when test="${loginStatus == 'logined'}">
                            <div class="items_container_input">
                                <textarea id="textarea" placeholder="Aa" maxlength="100"></textarea>
                            </div>
                        ...
                        <c:otherwise>
                            <div class="not_login_container">
                                <p>👋 You need to <a href="firstLoginPage">login</a> first 👋</p>
                            </div>
                        </c:otherwise>
                    </c:choose>
                </div>
        ...
        <script>
            ...
            textarea &&
                    textarea.addEventListener('keydown', function (e) {
                        if (e.key !== 'Enter' || e.target.value.length === 0)
                            ...
                            addDocument('${currentUser.name}', '${currentUser.email}', value, '${currentUser.avatar}');
                        }
                        textarea.value = '';
                    });
            ...
            likeButton &&
                    likeButton.addEventListener('click', function () {
                        addDocument('${currentUser.name}', '${currentUser.email}', null);
                    });
            // Functions
