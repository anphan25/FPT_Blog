...
<html lang="en">
  ...
  <body>
    ...
    Some tags, such as âhelpâ or âhealthydebateâ, have special posting guidelines.</li></div>`;
          ref.innerHTML = stringHtml;
        }
      }
    </script>
